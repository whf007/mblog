...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon-precomposed" href="<@resource src=profile.avatar/>"/>
    <link rel="shortcut icon" href="<@resource src=profile.avatar/>"/>
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2019 <a href="#">xiaofei</a>.</strong> All rights reserved.
    </footer>
</body>
</html>
</#macro>
